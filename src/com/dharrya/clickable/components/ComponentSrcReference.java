...
public class ComponentSrcReference implements PsiReference  {
        ...
        public ComponentSrcReference(String path, PsiElement element, TextRange textRange, Project project, VirtualFile appDir) {
    ...
    public PsiElement resolve() {
        final String path = mPath.replace(":", "/");
        PsiElement result = getTargetFile(path, "component.php");
        if(result == null) {
            result = getTargetFile(path, "class.php");
        }
